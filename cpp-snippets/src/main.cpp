...
template <typename T1, typename T2> map_wrapper<T1, T2> make_map(T1 t1, T2 t2) {
  return {t1, t2};
}
...
int main(int argc, char *argv[]) {
  ...
  map_wrapper<float, std::string> mapa1{
      2.0, std::string("Hello")}; // OK but inconvinient and old way
